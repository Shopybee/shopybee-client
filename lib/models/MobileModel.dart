...
List<MobileModel> mobileModelFromMap(String str) =>
    List<MobileModel>.from(json.decode(str).map((x) => MobileModel.fromMap(x)));

String mobileModelToMap(List<MobileModel> data) =>
